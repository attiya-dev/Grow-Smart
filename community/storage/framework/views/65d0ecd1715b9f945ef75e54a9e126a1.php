<?php $__env->startSection('title', (is_urdu() ? 'موسم گرما کی فصلیں' : 'Summer Crops') . ' | GrowSmart'); ?>
    ...
    <div class="crop-page-header">
        ...
        <div class="header-content">
            ...
            <div class="crop-page-label">
                ...
                <?php echo e(t('Summer Season', 'موسم گرما')); ?>
            ...
            <p class="crop-page-subtitle">
                <?php echo e(t('Discover crops suitable for the summer season and explore detailed information about their cultivation and management.', 'موسم گرما کے لیے موزوں فصلوں کو دیکھیں اور ان کی کاشت اور انتظام کے بارے میں تفصیلی معلومات حاصل کریں۔')); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="col-12">
                    ...
                    <div class="empty-state">
                        ...
                        <h5>
                            No <?php echo e(t('Summer Crops', 'موسم گرما کی فصلیں')); ?> Available
                        </h5>

                        <p>
                            <?php echo e(t('There are currently no summer crops available. Please check back later.', 'اس وقت موسم گرما کی کوئی فصل دستیاب نہیں ہے۔ براہِ کرم بعد میں دوبارہ دیکھیں۔')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/front/summer.blade.php ENDPATH**/ ?>