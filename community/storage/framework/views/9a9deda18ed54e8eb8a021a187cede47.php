<?php $__env->startSection('title', (is_urdu() ? 'پھل' : 'Fruits') . ' | GrowSmart'); ?>
...
<div class="crop-page">
    ...
    <div class="crop-hero">
        ...
        <p class="crop-page-subtitle">
            <?php echo e(t('Discover a variety of fruits and explore detailed agricultural information, growing guidance, and useful crop details.', 'مختلف پھلوں کو دیکھیں اور تفصیلی زرعی معلومات، کاشت کی رہنمائی اور فصل کی مفید تفصیلات حاصل کریں۔')); ?>
    ...
    <div class="crop-section">
        ...
        <div class="crop-section-header">
            ...
            <h2 class="crop-section-title">
                <?php echo e(t('Available Fruits', 'دستیاب پھل')); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="col-12">
                    ...
                    <div class="empty-state">
                        ...
                        <h5>
                            <?php echo e(t('No Fruits Available', 'کوئی پھل دستیاب نہیں ہیں')); ?>

                        </h5>

                        <p>
                            <?php echo e(t('There are currently no fruits available to display.', 'اس وقت دکھانے کے لیے کوئی پھل دستیاب نہیں ہے۔')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/front/fruit.blade.php ENDPATH**/ ?>