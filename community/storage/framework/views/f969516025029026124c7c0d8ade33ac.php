<?php $__env->startSection('title', (is_urdu() ? 'اناج' : 'Grains') . ' | GrowSmart'); ?>
...
<div class="crop-page">
    ...
    <div class="crop-hero">
        ...
        <p class="crop-page-subtitle">
            <?php echo e(t('Explore different types of grains and discover useful agricultural information, growing guidance, and crop details.', 'مختلف اقسام کے اناج کو دیکھیں اور مفید زرعی معلومات، کاشت کی رہنمائی اور فصل کی تفصیلات حاصل کریں۔')); ?>
    ...
    <div class="crop-section">
        ...
        <div class="crop-section-header">
            ...
            <h2 class="crop-section-title">
                <?php echo e(t('Available Grains', 'دستیاب اناج')); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="col-12">
                    ...
                    <div class="empty-state">
                        ...
                        <h5>
                            <?php echo e(t('No Grains Available', 'کوئی اناج دستیاب نہیں ہے')); ?>

                        </h5>

                        <p>
                            <?php echo e(t('There are currently no grains available to display.', 'اس وقت دکھانے کے لیے کوئی اناج دستیاب نہیں ہے۔')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/front/grains.blade.php ENDPATH**/ ?>