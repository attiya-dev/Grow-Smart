...
<div class="container">
   ...
   <div class="heading"> 
    <h1>
        <?php echo e(app()->getLocale() === 'ur' ? '🌾 فصل کمیونٹی' : '🌾 Crop Community'); ?>
    ...
    <p>
        <?php echo e(app()->getLocale() === 'ur'
            ...
            : 'Ask your crop questions and get help from agricultural experts.'); ?>
    ...
    <div class="form-box">
        ...
        >
            ...
            <div class="form-group">
                ...
                <label><?php echo e(t('Upload Crop Image', 'فصل کی تصویر اپ لوڈ کریں')); ?></label>
            ...
            <div class="form-group">
                ...
                <textarea
                    name="question_text"
                    id="question_text"
                    placeholder="<?php echo e(t('Write your crop problem here...', 'اپنی فصل سے متعلق مسئلہ یہاں لکھیں...')); ?>"
                ></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/user/crop.blade.php ENDPATH**/ ?>