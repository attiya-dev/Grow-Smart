...
<div id="sidebar">
    ...
    <div class="sidebar-logo">
        ...
        <div>
            ...
            <div class="sidebar-logo-text">
                <?php echo e(is_urdu() ? 'گرو اسمارٹ' : 'GrowSmart'); ?>
    ...
    <ul>
        ...
        <li>
            ...
            <a
                href="/grid"
                class="<?php echo e(request()->is('grid') ? 'active' : ''); ?>"
            >

                <i class="bi bi-bar-chart"></i>

                <span>
                    <?php echo e(t('Crop Data', 'فصلوں کا ڈیٹا')); ?>
        ...
        <li>
            ...
            >
                ...
                <span>
                    <?php echo e(t('Pest Management', 'کیڑوں کا انتظام')); ?>
        ...
        <li>
            ...
            >
                ...
                <span>
                    <?php echo e(is_urdu() ? 'کمیونٹی' : 'Community'); ?>
        ...
        <li>
            ...
            >
                ...
                <span>
                    <?php echo e(t('AI Soil Analysis', 'مصنوعی ذہانت سے مٹی کا تجزیہ')); ?>
        ...
        <li>
            ...
            >
                ...
                <span>
                    <?php echo e(t('Weather Information', 'موسم کی معلومات')); ?>
        ...
        <li>
            ...
            >
                ...
                <a href="<?php echo e(route('profile')); ?>">
                    ...
                    <span>
                        <?php echo e(t('Add Profile Picture', 'پروفائل تصویر شامل کریں')); ?>
                ...
                <a href="<?php echo e(route('account.settings')); ?>">
                    ...
                    <span>
                        <?php echo e(t('Account Settings', 'اکاؤنٹ کی ترتیبات')); ?>
                ...
                >
                    ...
                    <span>
                        <?php echo e(t('Select Language', 'زبان منتخب کریں')); ?>
                ...
                <a href="<?php echo e(route('privacy.policy')); ?>">
                    ...
                    <span>
                        <?php echo e(t('Privacy Policy', 'رازداری کی پالیسی')); ?>
                ...
                <a href="<?php echo e(route('about.us')); ?>">
                    ...
                    <span>
                        <?php echo e(t('About Us', 'ہمارے بارے میں')); ?>
...
<nav class="navbar-main">
    ...
    <div class="navbar-inner">
        ...
        <div class="category-nav">
            ...
            >
                <?php echo e(t('Summer Crops', 'موسم گرما کی فصلیں')); ?>
            ...
            >
                <?php echo e(t('Winter Crops', 'موسم سرما کی فصلیں')); ?>
...
<footer class="footer">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <h5>
                    ...
                    <span class="brand-name-protected" data-no-translate="true"><?php echo e(is_urdu() ? 'گرو اسمارٹ' : 'GrowSmart'); ?></span>
                </h5>
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <h5><?php echo e(is_urdu() ? 'فوری روابط' : 'Quick Links'); ?></h5>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <h5><?php echo e(is_urdu() ? 'خدمات' : 'Services'); ?></h5>
                ...
                <ul class="footer-links">
                    ...
                    <li>
                        <a href="/weather">
                            <?php echo e(t('Weather Forecast', 'موسم کی پیش گوئی')); ?>
                    ...
                    <li>
                        <a href="/community">
                            <?php echo e(is_urdu() ? 'ماہرین کی مدد' : 'Expert Support'); ?>
                    ...
                    <li>
                        <a href="/grid">
                            <?php echo e(is_urdu() ? 'فصلوں کا علم' : 'Crop Knowledge'); ?>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <h5><?php echo e(is_urdu() ? 'ہم سے رابطہ کریں' : 'Contact Us'); ?></h5>
                ...
                <p>
                    ...
                    &nbsp;<?php echo e(is_urdu() ? 'پاکستان' : 'Pakistan'); ?>
        ...
        <div class="footer-bottom">
            ...
            © <?php echo e(date('Y')); ?> <span data-no-translate="true"><?php echo e(is_urdu() ? 'گرو اسمارٹ' : 'GrowSmart'); ?></span>. <?php echo e(is_urdu() ? 'جملہ حقوق محفوظ ہیں۔' : 'All Rights Reserved.'); ?>


            <br>

            <?php echo e(is_urdu() ? 'ذہین زراعت کے ذریعے کسانوں کو بااختیار بنانا۔' : 'Empowering Farmers Through Smart Agriculture.'); ?>
...
<div id="logoutModal">
    ...
    <div class="logout-box">
        ...
        <p>
            <?php echo e(t('Are you sure you want to logout from GrowSmart?', 'کیا آپ واقعی گرو اسمارٹ سے خروج کرنا چاہتے ہیں؟')); ?>
        ...
        <div class="logout-actions">
            ...
            >
                ...
                >
                    <?php echo e(t('Yes, Logout', 'جی ہاں، خروج کریں')); ?>
...
<?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/layouts/app.blade.php ENDPATH**/ ?>