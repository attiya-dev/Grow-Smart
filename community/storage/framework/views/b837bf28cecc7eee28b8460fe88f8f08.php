...
<div class="questions-box">
    ...
    <div class="page-title">
        ...
        <p><?php echo e(t('Answer the user\'s crop questions', 'صارف کے فصلوں سے متعلق سوالات کے جوابات دیں۔')); ?></p>
    </div>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="question-card">
            ...
            <div class="question-title">
                🌾 <?php echo e(t('Crop Question', 'فصل سے متعلق سوال')); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="empty-box">
            <?php echo e(t('This user has no unanswered crop questions.', 'اس صارف کے کوئی غیر جوابی فصلوں سے متعلق سوالات موجود نہیں ہیں۔')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/expert/crop_user_questions.blade.php ENDPATH**/ ?>