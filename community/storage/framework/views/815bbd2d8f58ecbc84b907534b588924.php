...
<div class="expert-users-container" data-no-translate="true">
    ...
    <h2>🍎 <?php echo e(t('Users Fruit Questions', 'صارفین کے پھلوں سے متعلق سوالات')); ?></h2>
    <p class="intro">
        <?php echo e(t('Each user stays in this list until you manually remove them. Answered questions are still visible.', 'ہر صارف اس فہرست میں رہے گا جب تک آپ اسے خود نہ ہٹائیں۔ جواب دیے گئے سوالات بھی نظر آئیں گے۔')); ?>
        ...
        <div class="user-card">
            <div>
                ...
                <div class="question-count">
                    ...
                    <?php echo e($user->question_count == 1 ? t('Question', 'سوال') : t('Questions', 'سوالات')); ?>

                </div>

                <?php if($user->question_count > 0 && $user->answered_question_count == $user->question_count): ?>
                    <span class="completed">✓ <?php echo e(t('All questions answered', 'تمام سوالات کے جوابات دے دیے گئے ہیں')); ?></span>
                <?php endif; ?>
            </div>

            <div class="user-actions">
                <a href="<?php echo e(route('expert.fruit.user.questions', $user->id)); ?>" class="view-btn">
                    <?php echo e(t('View Questions', 'سوالات دیکھیں')); ?>

                </a>

                <div class="more-wrap">
                    <button type="button" class="more-btn" aria-label="<?php echo e(t('More options', 'مزید اختیارات')); ?>">⋮</button>
                    <div class="more-menu">
                        <form action="<?php echo e(route('expert.user.hide', $user->id)); ?>" method="POST" class="hide-user-form" data-category="fruit" data-user-name="<?php echo e($user->name); ?>">
                            ...
                            <button type="submit" class="delete-user">🗑 <?php echo e(t('Delete from list', 'فہرست سے حذف کریں')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="no-users">
            <?php echo e(t('No users have questions in this category.', 'اس زمرے میں کسی صارف کا کوئی سوال موجود نہیں۔')); ?>
...
<div class="expert-delete-modal" id="expertDeleteModal-fruit" aria-hidden="true">
    ...
    <div class="expert-delete-box" role="dialog" aria-modal="true">
        ...
        <h3><?php echo e(t('Remove user from list?', 'کیا آپ اس صارف کو اپنی فہرست سے حذف کرنا چاہتے ہیں؟')); ?></h3>
        <p id="expertDeleteMessage-fruit"><?php echo e(t('The user account and questions will not be deleted.', 'صارف کا اکاؤنٹ اور اس کے سوالات حذف نہیں ہوں گے۔')); ?></p>
        <div class="expert-delete-actions">
            <button type="button" class="expert-cancel-delete"><?php echo e(t('No', 'نہیں')); ?></button>
            <button type="button" class="expert-confirm-delete"><?php echo e(t('Yes, Delete', 'جی ہاں، حذف کریں')); ?></button>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/expert/fruit_users.blade.php ENDPATH**/ ?>