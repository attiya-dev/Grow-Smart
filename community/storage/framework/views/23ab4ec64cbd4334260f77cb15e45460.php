...
<head>
    ...
    <title><?php echo e(t('GrowSmart | Email Verification', 'گرو اسمارٹ | ای میل کی تصدیق')); ?></title>
...
<div class="container">
    ...
    <div class="left">
        ...
        <div class="brand">
            ...
            <div class="brand-text">
                ...
                <span class="brand-tagline"><?php echo e(t('Smart Agriculture', 'ذہین زراعت')); ?></span>
            </div>
        </div>
        ...
        <h2><?php echo e(t('Verify Your Email', 'اپنے ای میل پتے کی تصدیق کریں')); ?></h2>

        <p class="subtitle">
            <?php echo e(t('One more step to complete your GrowSmart account.', 'اپنے گرو اسمارٹ اکاؤنٹ کی تکمیل کے لیے یہ آخری مرحلہ ہے۔')); ?>
        ...
        <p class="info-text">
            <?php echo e(t('Enter the 6-digit verification code that was sent to your email address.', 'اپنے ای میل پتے پر بھیجا گیا 6 ہندسوں کا تصدیقی کوڈ درج کریں۔')); ?>
        ...
        >
            ...
            <input
                ...
                name="otp"
                class="otp-input"
                placeholder="<?php echo e(is_urdu() ? 'او ٹی پی درج کریں' : 'Enter OTP'); ?>"
                maxlength="6"
                minlength="6"
                inputmode="numeric"
                pattern="[0-9]{6}"
        ...
        >
            ...
            <?php echo e(t('Back to Register', 'رجسٹریشن پر واپس جائیں')); ?>
    ...
    <div class="right">
        ...
        <div class="right-content">
            ...
            <h3>
                <?php echo e(t('Welcome to', 'خوش آمدید')); ?><br>
                <?php echo e(t('GrowSmart', 'گرو اسمارٹ')); ?>

            </h3>

            <p>
                <?php echo e(t('Verify your email address and start benefiting from better agricultural information, farming solutions and our growing community.', 'اپنے ای میل پتے کی تصدیق کریں اور بہتر زرعی معلومات، کاشت کاری کے حل اور ہماری بڑھتی ہوئی کمیونٹی سے فائدہ اٹھانا شروع کریں۔')); ?>
...
<?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>