...
<div class="questions-box">
    ...
    <div class="page-title">
        ...
        <p><?php echo e(t('Answer the user\'s fruit questions', 'صارف کے پھلوں سے متعلق سوالات کے جوابات دیں۔')); ?></p>
    </div>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="question-card">
            ...
            <div class="question-title">
                🍎 <?php echo e(t('Fruit Question', 'پھل سے متعلق سوال')); ?>
            ...
            <?php if($question->answers->count()): ?>
                <div class="existing-answers" style="background:#f8fbf8;border:1px solid #dcebdd;border-radius:12px;padding:15px;margin-bottom:18px;">
                    <div style="color:#1b5e20;font-weight:bold;margin-bottom:10px;">
                        ✓ <?php echo e(t('Previous Expert Answers', 'ماہر کے سابقہ جوابات')); ?>

                    </div>
                    <?php $__currentLoopData = $question->answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div style="background:#fff;border-radius:10px;padding:12px;margin-bottom:8px;">
                            <strong>👨‍🌾 <?php echo e($answer->expert->name ?? t('Expert', 'ماہر')); ?></strong>
            ...
            <div class="answer-title">
                👨‍🌾 <?php echo e(t('Your Answer', 'آپ کا جواب')); ?>
            ...
            >
                ...
                <div>
                    ...
                    <label class="answer-label">
                        <?php echo e(t('Write Answer', 'جواب لکھیں')); ?>
                    ...
                    <textarea
                        name="answer_text"
                        class="answer-text"
                        placeholder="<?php echo e(t('Write your agricultural advice here...', 'اپنا زرعی مشورہ یہاں لکھیں...')); ?>"
                    ></textarea>
                ...
                <div style="margin-top:18px;">
                    ...
                    <label class="answer-label">
                        🖼️ <?php echo e(t('Answer Image', 'جواب کی تصویر')); ?>
                ...
                <div style="margin-top:18px;">
                    ...
                    <label class="answer-label">
                        🎤 <?php echo e(t('Record Voice Answer', 'آواز میں جواب ریکارڈ کریں')); ?>
                    ...
                    <div class="voice-record-area">
                        ...
                        <button
                            type="button"
                            class="recordBtn"
                            title="<?php echo e(t('Start recording', 'ریکارڈنگ شروع کریں')); ?>"
                        >
                            🎤
                        </button>
                ...
                >
                    👨‍🌾 <?php echo e(t('Submit Answer', 'جواب جمع کریں')); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="empty-box">
            <?php echo e(t('This user has no unanswered fruit questions.', 'اس صارف کے کوئی غیر جوابی پھلوں سے متعلق سوالات موجود نہیں ہیں۔')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/expert/fruit_user_questions.blade.php ENDPATH**/ ?>