...
<head>
    ...
    <title><?php echo e(t('GrowSmart - Create New Password', 'گرو اسمارٹ - نیا پاس ورڈ بنائیں')); ?></title>
...
<div class="reset-container">
    ...
    <div class="reset-box">
        ...
        <h2>
            🔐 <?php echo e(t('Create New Password', 'نیا پاس ورڈ بنائیں')); ?>
        ...
        >
            ...
            <label class="form-label">
                <?php echo e(t('Email Address', 'ای میل پتہ')); ?>
            ...
            <div class="password-input">
                ...
                <input
                    ...
                    id="newPassword"
                    class="form-control"
                    placeholder="<?php echo e(is_urdu() ? 'نیا پاس ورڈ درج کریں' : 'Enter new password'); ?>"
                    required
                ...
                <span
                    ...
                    title="<?php echo e(is_urdu() ? 'پاس ورڈ دکھائیں' : 'Show password'); ?>"
                >
            ...
            <div class="password-input">
                ...
                <input
                    ...
                    id="confirmPassword"
                    class="form-control"
                    placeholder="<?php echo e(is_urdu() ? 'نیا پاس ورڈ دوبارہ درج کریں' : 'Confirm new password'); ?>"
                    required
                    autocomplete="new-password"
                >
            ...
            <div class="password-info">
                ...
                <?php echo e(t('Password must be at least 8 characters long and contain at least one special character.', 'پاس ورڈ کم از کم 8 حروف پر مشتمل ہونا چاہیے اور اس میں کم از کم ایک خصوصی علامت شامل ہونی چاہیے۔')); ?>
            ...
            >
                ...
                🔑 <?php echo e(t('Reset Password', 'پاس ورڈ دوبارہ ترتیب دیں')); ?>
...
<?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>