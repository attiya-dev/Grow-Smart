...
<div class="weather-page" data-no-translate>
    ...
    <div class="weather-header">
        <div class="weather-header-content">
            ...
            <h1><?php echo e(is_urdu() ? 'موسم کی معلومات' : 'Weather Info'); ?></h1>

            <p>
                <?php echo e(is_urdu() ? 'اپنے علاقے کے موجودہ موسم اور آئندہ دنوں کی پیش گوئی دیکھیں۔ اس معلومات کی مدد سے اپنی زرعی سرگرمیوں کی بہتر منصوبہ بندی کریں۔' : 'Check the current weather and forecast for your area. Use this information to plan your farming activities.'); ?>
    ...
    <div id="loadingSection">
        ...
        <div class="location-box">
            ...
            <h4><?php echo e(is_urdu() ? 'موسم دیکھنے کے لیے مقام کی اجازت درکار ہے' : 'Weather Permission Required'); ?></h4>

            <p>
                <?php echo e(is_urdu() ? 'اپنے علاقے کا موجودہ موسم دیکھنے کے لیے اپنے مقام تک رسائی کی اجازت دیں۔' : 'Allow your location to see the current weather in your area.'); ?>

            </p>

            <button class="location-btn" onclick="getLocation()">
                <i class="bi bi-geo-alt me-2"></i>
                <?php echo e(is_urdu() ? 'مقام کی مدد سے موسم دیکھیں' : 'Show Weather Using Location'); ?>
    ...
    <div id="weatherSection" style="display:none;">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mt-3" style="font-size:13px;color:#c8d9d1;">
                        ...
                        <?php echo e(is_urdu() ? 'محسوس ہونے والا درجہ حرارت:' : 'Feels Like:'); ?>
                    ...
                    <div class="weather-details">
                        ...
                        <div class="weather-stat">
                            <div class="weather-stat-label">
                                ...
                                <?php echo e(is_urdu() ? 'نمی' : 'Humidity'); ?>
                        ...
                        <div class="weather-stat">
                            <div class="weather-stat-label">
                                ...
                                <?php echo e(is_urdu() ? 'حدِ نگاہ' : 'Visibility'); ?>
        ...
        <div class="section-heading">
            ...
            <div>
                <h3><?php echo e(is_urdu() ? 'پانچ دن کی موسم کی پیش گوئی' : 'Five Day Forecast'); ?></h3>

                <p>
                    <?php echo e(is_urdu() ? 'آنے والے دنوں کے موسمی حالات' : 'Weather conditions for the coming days'); ?>
        ...
        <div class="tips-section">
            ...
            <div class="tips-title">
                ...
                <?php echo e(is_urdu() ? 'کسانوں کے لیے مفید مشورے' : 'Farmer Tips'); ?>
...
function getLocation() {
    ...
    document.getElementById('loadingSection').innerHTML = `
        <div class="location-box loading-box">
            ...
            <p class="mt-3 mb-0"><?php echo e(is_urdu() ? 'آپ کا مقام تلاش کیا جا رہا ہے...' : 'Finding your location...'); ?></p>
        </div>
    `;
        ...
        function() {
            ...
            document.getElementById('loadingSection').innerHTML = `
                <div class="location-box">
                    ...
                    <h4><?php echo e(is_urdu() ? 'مقام کی اجازت درکار ہے' : 'Location Permission Required'); ?></h4>

                    <p>
                        <?php echo e(is_urdu() ? 'اپنے مقامی موسم کو دیکھنے کے لیے براہِ کرم اپنے براؤزر میں مقام تک رسائی کی اجازت دیں۔' : 'Please allow location access from your browser to see your local weather.'); ?>

                    </p>

                    <button class="location-btn" onclick="getLocation()">
                        <i class="bi bi-arrow-clockwise me-2"></i>
                        <?php echo e(is_urdu() ? 'دوبارہ کوشش کریں' : 'Try Again'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/weather.blade.php ENDPATH**/ ?>