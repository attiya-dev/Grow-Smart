...
<div class="container">
   ...
   <div class="heading"> 
    <h1>
        <?php echo e(app()->getLocale() === 'ur' ? ' 🍎 پھل برادری' : '🍎 Fruit Community'); ?>

    </h1>

    <p>
        <?php echo e(app()->getLocale() === 'ur'
            ? 'اپنی فصل سے متعلق سوالات پوچھیں اور زرعی ماہرین سے رہنمائی حاصل کریں۔'
            : 'Ask your fruit questions and get help from agricultural experts.'); ?>
    ...
    <div class="form-box">
        ...
        >
            ...
            <div class="form-group">
                ...
                <label><?php echo e(t('Upload Fruit Image', 'پھل کی تصویر اپ لوڈ کریں')); ?></label>
            ...
            <div class="form-group">
                ...
                <label>🎤 <?php echo e(t('Voice Question', 'صوتی سوال')); ?></label>
            ...
            <div class="form-group">
                ...
                <label><?php echo e(t('Ask Your Question', 'اپنا سوال پوچھیں')); ?></label>

                <textarea
                    name="question_text"
                    id="question_text"
                    placeholder="<?php echo e(t('Write your fruit problem here...', 'اپنی پھل سے متعلق مسئلہ یہاں لکھیں...')); ?>"
                ></textarea>
            ...
            <button
                ...
                class="submit-btn"
            >
                <?php echo e(t('Submit Question', 'سوال جمع کریں')); ?>
...
recordBtn.onclick = async function() {
    ...
    try {
        ...
        recorder.onstop = function() {
            ...
            recordBtn.innerHTML = "🎤";
            recordBtn.title = "<?php echo e(t('Start recording', 'ریکارڈنگ شروع کریں')); ?>";
        ...
        alert("<?php echo e(t('Please allow microphone permission to record your voice.', 'صوتی سوال ریکارڈ کرنے کے لیے براہِ کرم مائیکروفون کی اجازت دیں۔')); ?>");
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/user/fruit.blade.php ENDPATH**/ ?>