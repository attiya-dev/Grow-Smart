...
<div class="expert-users-container" data-no-translate="true">
    ...
    <h2>🌾 <?php echo e(t('Users Crop Questions', 'صارفین کے فصلوں سے متعلق سوالات')); ?></h2>
    <p class="intro">
...
<div class="expert-delete-modal" id="expertDeleteModal-crop" aria-hidden="true">
    ...
    <div class="expert-delete-box" role="dialog" aria-modal="true">
        ...
        <p id="expertDeleteMessage-crop"><?php echo e(t('The user account and questions will not be deleted.', 'صارف کا اکاؤنٹ اور اس کے سوالات حذف نہیں ہوں گے۔')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mg\Downloads\GitHub Projects\Grow-Smart\community\resources\views/expert/crop_users.blade.php ENDPATH**/ ?>