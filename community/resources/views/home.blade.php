        ...
        <div class="nav-right">
            ...
            <div class="home-language-switcher">
                ...
                <div class="home-language-menu" id="homeLanguageMenu">
                    <a href="{{ route('language.change', 'en') }}">English</a>
                    <a href="{{ route('language.change', 'ur') }}">اردو</a>
                </div>
            </div>
    ...
    <div class="hero-container">
        ...
        <div class="hero-content fade-up">
            ...
            <div class="hero-badge">
                ...
                {{ t('Welcome to GrowSmart', 'گرو اسمارٹ میں خوش آمدید') }}
            ...
            <h1>
                ...
                {{ t('Grow Smarter.', 'زیادہ سمجھداری سے اگائیں۔') }}<br>
            ...
            <div class="hero-buttons">
                ...
                @auth
                    <a
                        ...
                        class="btn-register"
                    >
                        {{ t('Go to My Dashboard', 'اپنے ڈیش بورڈ پر جائیں') }}
