...
<link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
    <title>{{ $cropDetail->crop_name }} Information</title>
...
<div class="container">
    ...
    <!-- Header -->
    <div class="header">
        <h1>{{ $cropDetail->crop_name }}</h1>
        <p>Complete Crop Information System</p>
    </div>
    ...
    <div class="section">
        ...
        <p>{{ $cropDetail->basic_information }}</p>
    </div>
    ...
    <div class="section">
        ...
        <pre>{{ $cropDetail->sowing_season }}</pre>
    </div>

    <!-- Harvesting Season -->
    <div class="section">
        <h2>Harvesting Season</h2>

        <pre>{{ $cropDetail->harvesting_season }}</pre>
    </div>
    ...
    <div class="section">
        ...
        <div class="info-box">
            <pre>{{ $cropDetail->climate_requirements }}</pre>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <pre>{{ $cropDetail->soil_requirements }}</pre>
    </div>

    <!-- Land Preparation -->
    <div class="section">
        <h2>Land Preparation</h2>
            <pre>{{ $cropDetail->land_preparation }}</pre>
        </div>
    ...
    <div class="section">
        ...
        <pre>{{ $cropDetail->seed_selection }}</pre>
    </div>
    ...
    <div class="section">
        <h2>Irrigation Requirements</h2>
            ...
            <pre>{{ $cropDetail->irrigation_requirements }}</pre>
        </div>
    ...
    <div class="section">
        <h2>Fertilizer Requirements</h2>
            ...
            <pre>{{ $cropDetail->fertilizer_requirements }}</pre>
        </div>
    ...
    <div class="section">
        ...
        <pre>{{ $cropDetail->growing_stages }}</pre>
    </div>
    ...
    <div class="section">
        <h2>Types of Crop</h2>
            ...
            <pre>{{ $cropDetail->types_of_crop }}</pre>
        </div>

    <!-- Varieties -->
    <div class="section">
        <h2>Major Crop Varieties in Pakistan</h2>

            <pre>{{ $cropDetail->crop_varieties }}</pre>
        </div>
    ...
    <div class="section">
        <h2>Nutritional Value</h2>
            ...
            <pre>{{ $cropDetail->nutritional_value }}</pre>
        </div>

    <!-- Importance -->
    <div class="section">
        <h2>Importance of Crop</h2>

        <pre>{{ $cropDetail->importance_of_crop }}</pre>
    </div>

    <!-- Modern Technology -->
    <div class="section">
        <h2>Modern Technologies in Crop Farming</h2>

            <pre>{{ $cropDetail->modern_technologies }}</pre>
        </div>

    <!-- Footer -->
    <div class="footer">
        <h3>Smart Farming Management System</h3>
        <p>Developed for Farmers & Agriculture Students</p>
    </div>
