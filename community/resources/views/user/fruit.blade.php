...
<div class="container">
   ...
   <div class="heading"> 
    <h1>
        {{ app()->getLocale() === 'ur' ? ' 🍎 پھل برادری' : '🍎 Fruit Community' }}
    </h1>
    ...
    <div class="form-box">
        ...
        >
            ...
            <div class="form-group">
                ...
                <label>{{ t('Upload Fruit Image', 'پھل کی تصویر اپ لوڈ کریں') }}</label>
            ...
            <div class="form-group">
                ...
                <textarea
                    name="question_text"
                    id="question_text"
                    placeholder="{{ t('Write your fruit problem here...', 'اپنی پھل سے متعلق مسئلہ یہاں لکھیں...') }}"
                ></textarea>
