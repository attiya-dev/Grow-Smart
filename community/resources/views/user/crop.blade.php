...
<div class="container">
   ...
   <div class="heading"> 
    <h1>
        {{ app()->getLocale() === 'ur' ? '🌾 فصل کمیونٹی' : '🌾 Crop Community' }}
    </h1>
    ...
    <div class="form-box">
        ...
        >
            ...
            <div class="form-group">
                ...
                <label>{{ t('Upload Crop Image', 'فصل کی تصویر اپ لوڈ کریں') }}</label>
            ...
            <div class="form-group">
                ...
                <textarea
                    name="question_text"
                    id="question_text"
                    placeholder="{{ t('Write your crop problem here...', 'اپنی فصل سے متعلق مسئلہ یہاں لکھیں...') }}"
                ></textarea>
