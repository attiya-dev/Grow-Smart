...
<div class="container py-4">
    <h2 class="text-center mb-4">{{ t('Fruit Questions', 'پھلوں سے متعلق سوالات') }}</h2>
    ...
    @empty
        <div class="alert alert-info text-center">{{ t('No fruit questions are available.', 'اس وقت پھلوں سے متعلق کوئی سوال موجود نہیں۔') }}</div>
    @endforelse
</div>
@endsection
