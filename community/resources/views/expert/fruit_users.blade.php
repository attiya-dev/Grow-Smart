...
<div class="expert-users-container" data-no-translate="true">
    ...
    <h2>🍎 {{ t('Users Fruit Questions', 'صارفین کے پھلوں سے متعلق سوالات') }}</h2>
    <p class="intro">
...
<div class="expert-delete-modal" id="expertDeleteModal-fruit" aria-hidden="true">
    ...
    <div class="expert-delete-box" role="dialog" aria-modal="true">
        ...
        <p id="expertDeleteMessage-fruit">{{ t('The user account and questions will not be deleted.', 'صارف کا اکاؤنٹ اور اس کے سوالات حذف نہیں ہوں گے۔') }}</p>
