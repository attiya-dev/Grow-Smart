...
<div class="questions-box">
    ...
    <div class="page-title">
        ...
        <p>{{ t('Answer the user\'s fruit questions', 'صارف کے پھلوں سے متعلق سوالات کے جوابات دیں۔') }}</p>
    </div>
    ...
    @forelse($questions as $question)
        ...
        <div class="question-card">
            ...
            <div class="question-title">
                🍎 {{ t('Fruit Question', 'پھل سے متعلق سوال') }}
            </div>
    ...
    @empty
        ...
        <div class="empty-box">
            {{ t('This user has no unanswered fruit questions.', 'اس صارف کے کوئی غیر جوابی پھلوں سے متعلق سوالات موجود نہیں ہیں۔') }}
        </div>
