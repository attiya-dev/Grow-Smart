...
<div class="container py-4">
    <h2 class="text-center mb-4">{{ t('Crop Questions', 'فصلوں سے متعلق سوالات') }}</h2>
    ...
    @empty
        <div class="alert alert-info text-center">{{ t('No crop questions are available.', 'اس وقت فصلوں سے متعلق کوئی سوال موجود نہیں۔') }}</div>
    @endforelse
</div>
@endsection
