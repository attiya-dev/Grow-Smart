...
<div class="expert-users-container" data-no-translate="true">
    ...
    <h2>🌾 {{ t('Users Crop Questions', 'صارفین کے فصلوں سے متعلق سوالات') }}</h2>
    <p class="intro">
...
<div class="expert-delete-modal" id="expertDeleteModal-crop" aria-hidden="true">
    ...
    <div class="expert-delete-box" role="dialog" aria-modal="true">
        ...
        <p id="expertDeleteMessage-crop">{{ t('The user account and questions will not be deleted.', 'صارف کا اکاؤنٹ اور اس کے سوالات حذف نہیں ہوں گے۔') }}</p>
